  ...
  home: `
    <section>
      ...
      <div class="hero-image">
        <img src ="images/website_toc.png" alt="Hero Image" class="hero-image">
    ...
    <section>
      ...
      <div class="research">
        ...
        <div class="research-box">
          <img src="images/salty_ice.png" alt="Salt Hydrate Image">
          <p>Salt hydrate mineralogy relevant to icy moon conditions</p>
        </div>
        <!-- Box 2 -->
        <div class="research-box">
          <img src="images/FunctionalMinerals.png" alt="Functional Materials Image">
          <p>Functional materials and their mineral counterparts</p>
        </div>
        <!-- Box 3 -->
        <div class="research-box">
          <img src="images/Diamond_inclusion_figure.png" alt="Diamond Defects Image">
          <p>Diamond defects and their inclusions</p>
        </div>
        <!-- Box 4 -->
        <div class="research-box">
          <img src="images/inbdc_indicatrix.png" alt="Compressibility Image">
          <p>Compressibility and thermal expansion behaviours</p>
        </div>
        <!-- Box 5 -->
        <div class="research-box">
          <img src="images/electron_diff.png" alt="Electron Diffraction Image">
      ...
      <div class="publication-text">
        <p>
          Trees DLA PhD position on 
          <a href = "https://www.trees-dla.ac.uk/projects/crystal-chemical-systematics-lithium-minerals-tool-future-positive-mining" target = "_blank">
      ...
      <div class="publication">
      <div class="publication-text">
        <p>Get in touch if interested in PhD or postdoctoral positions in our group.</p>
      </div>
      </div>
 ...
 `,
  ...
  publications: `
    <section>
      ...
      <div class="publication">
        <img src="images/MgCl2_10H2O_toc.png" alt="Publication 1 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Radiation_toc3.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Acetone_water_toc.gif" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/toc3.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/PBAs_toc_2021.gif" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/PBA_toc-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/DMA_staticTOC-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Metal_formates_Ptak2020.jpeg" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Ice_toc.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/MOFs_HP_toc.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/DMA_MossTOC-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/2_TOC-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Metal_formates_Ptak2019.jpeg" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/1_4HCB_toc-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/GaH2PO2_toc.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/TOC_PBA-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/TOC_8by4cm.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/DMAMF_TOC.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/AMF-II_TOCc-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Neon_MOF_TOC.jpg" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/ABX3_toc-01.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/GeometricMOFs.gif" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Homologous_mechanics.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/Agmim_supramolecular%20mechanics.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/ZnISN2_PDF.png" alt="Publication 2 Image">
        <div class="publication-text">
      ...
      <div class="publication">
        <img src="images/UrateOxidase.png" alt="Publication 2 Image">
        <div class="publication-text">
